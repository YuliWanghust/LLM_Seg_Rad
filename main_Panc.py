...
from trainer_Panc import run_training
...
parser.add_argument("--data_dir", default="./Panc/Totalsegmentator_dataset_v202", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./Panc/Train_total.json", type=str, help="dataset json file")
parser.add_argument("--save_checkpoint", action="store_true", help="save checkpoint during training")
parser.add_argument("--max_epochs", default=38, type=int, help="max number of training epochs")
...
def main_worker(gpu, args):
    ...
    #print("training cases:", len(loader[0].dataset), "validation cases:", len(loader[1].dataset))
    ...
    if args.use_ssl_pretrained:
        try:
            model_dict = torch.load("./swinuneter/model_swinvit.pt",weights_only=True)
    ...
    semantic_classes = ["Dice_Val_SmallBowel", "Dice_Val_LargeBowel", 
                        "Dice_Val_SpinalCord", "Dice_Val_Liver", "Dice_Val_Duodenum", 
                        "Dice_Val_Stomach", "Dice_Val_Kidney_L", "Dice_Val_Kidney_R"]
