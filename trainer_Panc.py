...
def run_training(
    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        if (epoch + 1) % args.val_every == 0:
            ...
            if args.rank == 0:
                #Dice_GTV = val_acc[0]
                Dice_SmallBowel = val_acc[0]
                Dice_LargeBowel = val_acc[1]
                Dice_SpinalCord = val_acc[2]
                Dice_Liver = val_acc[3]
                Dice_Duodenum = val_acc[4]
                Dice_Stomach = val_acc[5]
                Dice_Kidney_L = val_acc[6]
                Dice_Kidney_R = val_acc[7]
                print(
